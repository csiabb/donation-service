...
func (m *MockIDBBackend) CreateAccount(arg0 *Account) error {
	m.ctrl.T.Helper()
...
func (m *MockIDBBackend) CreateFunds(arg0 *PubFunds) error {
	m.ctrl.T.Helper()
...
func (m *MockIDBBackend) CreateSupplies(arg0 *PubSupplies) error {
	m.ctrl.T.Helper()
...
func (m *MockIDBBackend) QueryFunds(arg0, arg1, arg2 string, arg3 *structs.QueryParams) ([]*PubFunds, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "QueryFunds", arg0, arg1, arg2, arg3)
	ret0, _ := ret[0].([]*PubFunds)
	ret1, _ := ret[1].(error)
	return ret0, ret1
}
...
func (m *MockIDBBackend) QueryFundsDetail(arg0 string) (*FundsDetail, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "QueryFundsDetail", arg0)
	ret0, _ := ret[0].(*FundsDetail)
	ret1, _ := ret[1].(error)
	return ret0, ret1
}
...
func (m *MockIDBBackend) QuerySupplies(arg0, arg1, arg2 string, arg3 *structs.QueryParams) ([]*PubSupplies, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "QuerySupplies", arg0, arg1, arg2, arg3)
	ret0, _ := ret[0].([]*PubSupplies)
	ret1, _ := ret[1].(error)
	return ret0, ret1
}
...
func (m *MockIDBBackend) QuerySuppliesDetail(arg0 string) (*SuppliesDetail, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "QuerySuppliesDetail", arg0)
	ret0, _ := ret[0].(*SuppliesDetail)
	ret1, _ := ret[1].(error)
	return ret0, ret1
}
